  ...
  <>
    <Grid container spacing={2}>
      <Grid item xs={12}>
        ...
        <Typography>e.g) Financial Documents,Contracts, MoU etc </Typography>
      </Grid>
    </Grid>
  </>
);
...
export default function ComplianceViewEdit() {
  ...
  const handleSubmit = (values, actions) => {
    ...
    if (activeStep === steps.length - 1) {
      ...
      if(isEdit){
        setLoading(true);
        console.log(values);
        delete values['application_date']
        delete values['approval_date']
  ...
  return (
    <MainCard title={'Compliance Details'}>
      <Box sx={{ width: '100%' }}>
              ...
              <Form>
                {activeStep === 0 && (
                  <Box mt={2}>
                    ...
                    <>
                    <Field name="name" as={TextField} label="Organization Name" fullWidth margin="normal" disabled={true} />
                    ...
                    <Field name="contact_person_email_address" as={TextField} label="Contact Person Email Address" fullWidth margin="normal" disabled={true} />
                    <ErrorMessage name="contact_person_email_address" component={FormHelperText} error />

                    <Field name="application_date" as={TextField} label="Application Date" type="datetime-local" fullWidth margin="normal" InputLabelProps={{ shrink: true }} disabled={true} />
                    <ErrorMessage name="application_date" component={FormHelperText} error />

                    <Field name="approval_date" as={TextField} label="Approval Date" type="datetime-local" fullWidth margin="normal" InputLabelProps={{ shrink: true }} disabled={true} />
