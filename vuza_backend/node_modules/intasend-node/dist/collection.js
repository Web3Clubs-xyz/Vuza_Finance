...
var Collection = /*#__PURE__*/function (_RequestClient) {
  function Collection() {
    _classCallCheck(this, Collection);
    return _callSuper(this, Collection, arguments);
  }
  _inherits(Collection, _RequestClient);
  return _createClass(Collection, [{
    key: "charge",
    value: function charge(payload) {
      this.secret_key = '';
      return this.send(payload, '/api/v1/checkout/', 'POST');
    }
  }, {
    key: "mpesaStkPush",
    value: function mpesaStkPush(payload) {
    ...
    key: "status",
    value: function status(invoiceID) {
      var checkoutID = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
