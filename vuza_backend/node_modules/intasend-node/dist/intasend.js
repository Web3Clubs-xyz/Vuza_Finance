...
var IntaSend = /*#__PURE__*/function (_RequestClient) {
  function IntaSend(publishable_key, secret_key, test_mode) {
    _classCallCheck(this, IntaSend);
    return _callSuper(this, IntaSend, [publishable_key, secret_key, test_mode]);
  }
  _inherits(IntaSend, _RequestClient);
  return _createClass(IntaSend, [{
    key: "wallets",
    ...
    value: function collection() {
      return new Collection(this.publishable_key, this.secret_key, this.test_mode);
    }
  }, {
    key: "payouts",
